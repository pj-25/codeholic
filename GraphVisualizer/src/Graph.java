...
public class Graph {
    ...
    static Line createEdge(Node fromNode, Node toNode){
        double x1 = fromNode.getNode().getCenterX();
        double y1 = fromNode.getNode().getCenterY();
        double x2 = toNode.getNode().getCenterX();
        double y2 = toNode.getNode().getCenterY();
    ...
    void resetNodesColor(){
        for(Node node:nodeList){
            node.getNode().setFill(Color.RED);
        }
    }
